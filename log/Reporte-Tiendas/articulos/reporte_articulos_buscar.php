        ...
        if ($i == $proceso) {
           ...
           if ($base_dato == 'PREVIA_A') {
            ...
            if ($linea=='Todos') {
                ...
                $solicitud="SELECT * from st_almac inner join art on st_almac.co_art=art.co_art where  st_almac.stock_act > 0 and st_almac.co_alma='$almacen'";
    
               }else {
    
                $solicitud="SELECT * from st_almac inner join art on st_almac.co_art=art.co_art where art.co_lin='$linea' and st_almac.stock_act > 0 and st_almac.co_alma='$almacen'";
...
$consulta= sqlsrv_query($conn,$solicitud);
       ...
       // $ultimo=number_format($ult_cost, 2, ',', '.');
        ...
        $calculo_ultimo_costo= $costo *  3300000 ;
