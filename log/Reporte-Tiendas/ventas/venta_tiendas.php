  ...
  <input type="date" name="fecha" id="" required >
   ...
   -->
     ...
     <h2>Factura Con Renglones</h2>
      ...
      <form action="reporte_venta_diariat.php" method="post" id="formulario" enctype="multipart/form-data">
  ...
  <label for="sedes_nom" class="form-label mt-2">Tiendas</label>
    ...
    <div class="col">
     <h2>Por tiendas</h2>
      ...
      <form action="resumen_venta_diaria.php" method="post" id="formulario" >
  <center><h2>Venta Diarias</h2></center>
  

  <label for="sedes_nom" class="form-label mt-2">Tiendas</label>
    <select name="sedes_nom" id="" class='form-control' >
