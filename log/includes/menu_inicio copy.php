  ...
  <nav id="navbar" class="navbar">
    <ul id="navbar-nav" class="navbar-nav">
      ...
      <li id="nav-item" class="nav-item">
        <a href="equipos/equipo.php" id="nav-link" class="nav-link">
        <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fad"
      ...
      <li id="nav-item" class="nav-item">
        <a href="fiscales/fiscales.php" id="nav-link" class="nav-link">
        <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fad"
      ...
      <li id="nav-item" class="nav-item">
        <a href="stock/stock.php" id="nav-link" class="nav-link">
        <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fad"
