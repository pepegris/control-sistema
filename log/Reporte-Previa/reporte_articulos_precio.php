...
$consulta= sqlsrv_query($conn,$solicitud);
        ...
        while ($row=sqlsrv_fetch_array($consulta)) {
            ...
            $precio_4 = round($row[prec_vta4]) ;
            $costo=number_format($precio_4, 2, ',', '.');
            ...
            $suma_costo+=$precio_4;
            $total_costo=number_format($suma_costo, 2, ',', '.');
        ...
        if ($conexion == 0) {
            ...
            echo "<tr><td ></td><td class='text-right ' >Total</td><td >Bs. $total_bol</td><td></td><td >Bs. $total_costo</td><td >Bs. $total_ult</td><td>$total</td> </tr>";
