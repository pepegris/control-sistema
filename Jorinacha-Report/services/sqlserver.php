        ...
        try {
            ...
            if ($linea === 'todos') {
                ...
                if ($database == 'PREVIA_A') {
                    ...
                    $sql = "SELECT TOP 32 LTRIM(RTRIM(art.co_art)) as  co_art ,LTRIM(RTRIM(art.co_subl)) as  co_subl,LTRIM(RTRIM(art.co_cat)) as  co_cat,
                    ...
                    $sql = "SELECT TOP 32 LTRIM(RTRIM(co_art)) as  co_art  ,LTRIM(RTRIM(co_subl)) as  co_subl  ,LTRIM(RTRIM(co_cat) as  co_cat  , 
