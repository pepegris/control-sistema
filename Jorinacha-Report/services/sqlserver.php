            ...
            if ($linea === 'todos') {
                ...
                if ($database == 'PREVIA_A') {
                    ...
                    $sql = "SELECT  LTRIM(RTRIM(art.co_art)) as  co_art ,LTRIM(RTRIM(art.co_subl)) as  co_subl,LTRIM(RTRIM(art.co_cat)) as  co_cat,
                        ...
                        where   st_almac.co_alma='BOLE' AND art.prec_vta5 >=1 AND art.fe_us_in >= '20170101'  AND art.anulado=0
                    ...
                    from art WHERE prec_vta5 >= 1 AND art.fe_us_in >= '20170101'  AND art.anulado=0 ORDER BY co_subl  DESC";
                }
            } elseif ($co_art == 0) {
                ...
                if ($database == 'PREVIA_A') {
                    ...
                    from st_almac inner join art on st_almac.co_art=art.co_art 
                    where art.co_lin='$linea' and st_almac.co_alma='BOLE' AND art.prec_vta5 >=1 AND art.fe_us_in >= '20170101'  AND art.anulado=0
                    order by art.co_subl   desc";
                    /*                     } */
                } else {
                    ...
                    from art  where co_lin= '$linea' AND prec_vta5 >= 1 AND art.fe_us_in >= '20170101'  AND art.anulado=0 ORDER BY co_subl  DESC";
                }
            } else {
