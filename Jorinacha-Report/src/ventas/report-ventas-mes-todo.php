      ...
      <tbody>
        ...
        for ($i = 1; $i < count($sedes_ar); $i++) {
          ...
          if ($divisa == 'dl') {
            ...
            $tasas = getTasas($sedes_ar[$u],  $fecha_2);
          ...
          $dev_cli = getDev_cli($sedes_ar[$u], $fecha1, $fecha3, 'sin');
          ...
          $factura_ven = getFactura($sedes_ar[$u], $fecha1, $fecha3, 'ven');
          $total_art_factura +=  number_format($factura_ven['total_art'], 0, ',', '.');

          $dev_cli_ven = getDev_cli($sedes_ar[$u], $fecha1, $fecha3, 'ven');
          $total_art_dev_cli += number_format($dev_cli_ven['total_art'], 0, ',', '.');


          $dep_caj = getDep_caj($sedes_ar[$u], $fecha1, $fecha3, 'sin');
