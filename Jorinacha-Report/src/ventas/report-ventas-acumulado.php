  ...
  <table class="table table-dark table-striped" id="tblData">
    ...
    <tbody>
      ...
      for ($i = 1; $i < count($sedes_ar); $i++) {
        ...
        $factura = getFactura($sedes_ar[$i], $fecha1, $fecha2, 'ven');
        ...
        $dev_cli = getDev_cli($sedes_ar[$i], $fecha1, $fecha2, 'ven');
        ...
        $dep_caj = getDep_caj($sedes_ar[$i], $fecha1, $fecha2, 'ven');
