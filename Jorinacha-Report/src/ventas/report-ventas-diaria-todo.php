          ...
          <tr>
            ...
            <td> <?php
                  ...
                  if ($venta <= 1 & $total_art_factura == 0) {
                    ...
                    $diferencias = $monto_ord_pago + $monto_ord_pago_ven + $monto_h_mov_ban - $tot_neto_factura;
                    ...
                    $diferencias = $total_efec_dep_caj + $total_tarj_dep_caj + $monto_ord_pago + $monto_ord_pago_ven - $tot_neto_factura;
