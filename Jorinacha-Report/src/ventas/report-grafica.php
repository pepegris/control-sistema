  ...
  <head>
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          title: 'Modelos vendidos por Puerto 2023',
          is3D: true,
        };
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          <?php
            ...
            inner join art  on art.co_art=reng_fac.co_art
            inner join lin_art on lin_art.co_lin=art.co_lin
            where factura.anulada =0 and factura.fec_emis between '20240101' and '20241231'
            group by lin_art.lin_des 
            order by total_art desc";
        ...
        var options = {
          title: 'Modelos vendidos por Puerto 2024',
          is3D: true,
        };
