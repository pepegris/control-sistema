    ...
    ['Mes', 'Sucursal Caracas I', 'Sucursal Caracas II"',
       ...
       'Comercial Nachari','Comercial Corina II','Comercial Catica II'],
        ...
        for ($k = $Month_beg; $k <= $Month_total; $k++) {
            ...
            WHERE mes='$Month' and tienda= '$sede1'";
            ...
            WHERE mes='$Month' and tienda= '$sede2'";
            ...
            WHERE mes='$Month' and tienda= '$sede3'";
           ...
           ///////////////////////////////////////////////////////////////////
            ...
            WHERE mes='$Month' and tienda= '$sede4'";
            ...
            WHERE mes='$Month' and tienda= '$sede5'";
            ...
            WHERE mes='$Month' and tienda= '$sede6'";
            ...
            WHERE mes='$Month' and tienda= '$sede7'";
            ...
            WHERE mes='$Month' and tienda= '$sede8'";
            ...
            WHERE mes='$Month' and tienda= '$sede9'";
            ...
            WHERE mes='$Month' and tienda= '$sede10'";
            ...
            WHERE mes='$Month' and tienda= '$sede11'";
            ...
            WHERE mes='$Month' and tienda= '$sede12'";
            ...
            WHERE mes='$Month' and tienda= '$sede13'";
            ...
            WHERE mes='$Month' and tienda= '$sede14'";
            ...
            WHERE mes='$Month' and tienda= '$sede15'";
            ...
            WHERE mes='$Month' and tienda= '$sede16'";
            ...
            WHERE mes='$Month' and tienda= '$sede17'";
...
/*             $sede1_t=$total_sede1-$total2_sede1;
            ...
            $sede8_t=$total_sede8;
            $sede9_t=$total_sede9;
            $sede10_t=$total_sede10;
            $sede11_t=$total_sede11;
            $sede12_t=$total_sede12;
            $sede13_t=$total_sede13;
            $sede14_t=$total_sede14;
            $sede15_t=$total_sede15;
            $sede16_t=$total_sede16;
            $sede17_t=$total_sede17;
            $mes = Meses($Month);
            echo "['".$mes."',
      ...
      var options = {
          title: 'Articulos Despachados Por Tiendas',
...
<br>
<center>
  <h1> Articulos Despachados de Tiendas por Mes desde <?= $fecha_titulo1  ?> hasta <?= $fecha_titulo2  ?></h1>
