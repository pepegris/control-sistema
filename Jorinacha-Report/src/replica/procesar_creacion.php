...
<div class="main-container report-container">
    ...
    if (empty($data_articulos) && empty($data_lineas) && empty($data_colores) && empty($data_cat)) {
        ...
        // --- CAMBIO AQUÍ: GUARDAMOS LA FECHA DE HOY ---
        file_put_contents($ruta_txt, date('Y-m-d'));
        // ----------------------------------------------
    ...
    // --- CAMBIO AQUÍ TAMBIÉN: GUARDAMOS LA FECHA DE HOY AL FINALIZAR ---
