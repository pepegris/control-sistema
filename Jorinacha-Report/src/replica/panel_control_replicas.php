<?php include '../../services/adm/replica/config_replicas.php'; ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="container" style="max-width: 700px;">
    ...
    <a href="replica.php" class="back-btn">← Volver al Reporte Principal</a>

    <h3>🔄 Reiniciar Suscripciones (Modo VPN)</h3>
    <div class="alert alert-dark border-warning text-warning">
